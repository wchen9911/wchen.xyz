    ...
    <main className="min-h-screen bg-[#fdfdfc] text-[#1a1a1a] font-sans selection:bg-[#bc1a22] selection:text-white transition-colors duration-300">
      ...
      <div className="max-w-3xl mx-auto pt-32 px-6 pb-24 space-y-16">
        <header className="space-y-4">
          ...
          <p className="text-zinc-500 text-lg italic leading-relaxed border-l-4 border-zinc-100 pl-8">Thoughts on leadership, developer experience, and the craft of engineering management.</p>
        </header>

        <div className="space-y-8">
          {portfolioData.articles.map((article) => (
            <article key={article.slug} className="group relative flex flex-col items-start bg-[#f4f4f0]/50 p-10 rounded-[2.5rem] border border-transparent hover:border-zinc-200 transition-all hover:shadow-xl">
              ...
              <p className="relative z-10 mt-4 text-zinc-500 leading-relaxed text-sm font-medium">
                {article.excerpt}
              </p>
